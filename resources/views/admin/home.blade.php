                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="p-3">
                            <ul class="nav nav-pills nav-justified mb-3" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-second-tab" data-toggle="pill" href="#pills-second"
                                        role="tab" aria-controls="pills-second" aria-selected="false">2022</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-third-tab" data-toggle="pill" href="#pills-third"
                                        role="tab" aria-controls="pills-third" aria-selected="false">2023</a>
                                </li>
                            </ul>
    ...
    <div class="col-xl-3">
        <div class="card">
            <div class="card-body text-center">
                <h4 class="mt-0 header-title mb-4">Jumlah Berita</h4>
                <div class="p-3 ">
                    <h2>{{$artikel}}</h2>
                </div>
