...
<div class="row">
    <div class="col-12">
        <div class="card m-b-20">
            <div class="card-body">
                <form method="POST" action="/data/profil/edit/{{$data->id}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control form-control-lg" name="deskripsi"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" value="{{$data->telp}}" name="telp"
                                id="example-text-input">
                        </div>
                    </div>
                    <div class="form-group row">
